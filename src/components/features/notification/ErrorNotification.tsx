...
const ErrorNotification = () => {
  ...
  return (
    <div className="fixed w-screen h-screen top-0 left-0 bg-gray-800/20 backdrop-blur-sm z-110 flex items-center justify-center">
      <div className="flex flex-col border border-gray-300 w-50 sm:w-70 px-3 sm:px-5  py-8 pb-10 justify-center items-center rounded-xl gap-1 relative bg-white ">
        ...
        <p className="sm:text-xl  font-medium text-red-500">
          Something Went Wrong!
        </p>
        <p className="text-gray-600 text-sm">Please Try Again Later</p>
        <span
          style={{ width: `${width}%` }}
          className={` $ h-2 bg-red-400 absolute bottom-0 rounded-bl-xl rounded-br-xl left-0`}
        ></span>
      </div>
    </div>
  );
